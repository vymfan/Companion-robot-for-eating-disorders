...
with open(filename, 'w', newline='') as file:
    ...
    writer.writerow(["Frame", "Average Distance between centers", "Average Distance between bottom face and hand", "Average Distance between top face and hand", "Average Distance between lef face and hand", "Average Distance between right face and hand", "Eating ?"])
